...
def test_excel_filter_cash_transactions():
    ...
    assert -53977.4 in transactions['P']['W'], f"Should find withdrawal amount -53977.4 in Series P, found {transactions['P']['W']}"
    assert 914072.5 in transactions['I']['D'], f"Should find deposit amount 914072.5 in Series I, found {transactions['I']['D']}"
