...
def update_excel_with_transactions(
    ...
    try:
        ...
        if "ESG016 - Wespath Series P" in workbook.sheetnames:
            update_series_worksheet(
                workbook["ESG016 - Wespath Series P"], transactions["P"], date
            )
        else:
        ...
        if "ESG017 - Wespath Series I" in workbook.sheetnames:
            update_series_worksheet(
                workbook["ESG017 - Wespath Series I"], transactions["I"], date
            )
        else:
...
def update_series_worksheet(
    worksheet, series_data: Dict[str, List[float]], date: str
) -> None:
    """
